...
public class PostingsAll extends BaseEndpoint implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if ("GET".equals(httpExchange.getRequestMethod())) {
            ...
            try {
                String Response = gson.toJson(db.writePostings(db.connectDataBase()).subList(21,25));//тут можно убрать ограничение в кол-во записей
